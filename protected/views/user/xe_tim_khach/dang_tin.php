...
$this->pageTitle = Yii::app()->name . ' - Đăng tin xe tìm khách';
    ...
    <table class="dangtin">
        <tr>
            <td colspan="4" id="error">
                ...
                <div>
                    <p><?php echo $form->error($xeTimKhach, 'dia_chi_di'); ?></p>
                    <p><?php echo $form->error($xeTimKhach, 'dia_chi_den'); ?> </p>
                    <p><?php echo $form->error($xeTimKhach, 'ngay_khoi_hanh'); ?> </p>
                </div>
