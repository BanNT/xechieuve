                    ...
                    <ul class="dropdown-menu" style="padding: 0">
                        ...
                        <li>
                            ...
                            <ul style="padding: 0" class="dropdown-menu sub-menu">
                                <li>
                                    <a style="color: #000" href="<?php echo CHtml::encode(Yii::app()->request->baseUrl); ?>/tin-da-dang/tin-xe-tim-khach/2">
                                        Tin khách tìm xe
                                    </a>
                                </li>
                                <li>
                                    <a style="color: #000" href="<?php echo CHtml::encode(Yii::app()->request->baseUrl); ?>/tin-da-dang/tin-xe-tim-khach/1">
                                        Tin xe tìm khách
                                    </a>
                                </li>
                                <li>
                                    <a style="color: #000" href="<?php echo CHtml::encode(Yii::app()->request->baseUrl); ?>/tin-da-dang/tin-rao-vat/3";>
                                        Tin rao vặt
                                    </a>
                                </li>
                            </ul>
